            ...
            addPage: function(a, b) {
                ...
                1 <= b &&
                    ...
                    ((c = 'double' == e.display ? (b % 2 ? ' odd' : ' even') : ''),
                        ...
                        (e.pageObjs[b] = f(a)
                            .css({ float: 'left' })
                            .addClass('page p' + b + c)), -1 != navigator.userAgent.indexOf('MSIE 9.0') &&
            ...
            _addPage: function(a) {
                ...
                if (c)
                    if (g._necessPage.call(this, a)) {
                        if (!b.pageWrap[a]) {
                            b.pageWrap[a] = f('<div/>', {
                                //class: 'page-wrapper page:a',
                                class: 'page-wrapper page-wrapper-' + a,
                                id: 'page-' + a,
                                value: a,
                                name: a,
                                page: a,
            ...
            destroy: function() {
                ...
                if ('prevented' != t('destroying', this)) {
                    ...
                    for (
                        ...
                        .unbind(r.up, b.eventHandlers.touchEnd); 0 !== b.totalPages;
                ...
                if (this.turn('animating') && 0 !== b.pageMv[0]) {
                    ...
                    for (a in b.pageWrap)
                        if (
                            ...
                            .flip('hover', !1)
                            .flip(
                                'disable', -1 == f.inArray(parseInt(a, 10), b.pageMv) &&
                                a != i[0] &&
                                a != i[1]
                            ) :
                            c
